...
inline std::unordered_map<const char*, CSignature*> g_SigMap = {
	...
	*/
	...
	RawSig("SetBodyDynamic", "\x88\x91\x00\x00\x00\x00\x4C\x8B\xC1", "xx????xxx")
	...
	*/
	...
	Sig("WriteToConsole", "\x80\x79\x0F\x00\x74\x03\x48\x8B\x09\x48\x8B\xD1\x48\x8D\x0D\x00\x00\x00\x00", "xxxxxxxxxxxxxxx????")
