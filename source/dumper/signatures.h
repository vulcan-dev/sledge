...
inline std::unordered_map<const char*, CSignature*> g_SigMap = {
	...
	*/
	...
	Sig("GetString", "\xE8\x00\x00\x00\x00\x48\x8B\xF8\x45\x33\xF6", "x????xxxxxx")
	...
	*/
	...
	/*
		constructors
	*/
	Sig("Game", "\xE8\x00\x00\x00\x00\x4C\x8B\xF0\xEB\x03\x4D\x8B\xF7\x41\x8B\xF7", "x????xxxxxxxxxxx")

	Sig("Body", "\xE8\x00\x00\x00\x00\x48\x8B\xF8\x33\xDB\xEB\x04", "x????xxxxxxx")
