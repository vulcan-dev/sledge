...
namespace Teardown {
	...
	inline bool (*QueryClosestPoint) (Scene* pScene, Vector3* vOrigin, Vector3* vDirection, float fMaskDist, SQueryFilter* pFilter, Vector3** vHitPos, Vector3** vHitNormal, Shape** pHitShape, void* pUnk);
